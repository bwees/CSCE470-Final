/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8b8fe0ad394c29fa2ed95304063fdcf3)
// Runtime types generated with workerd@1.20260405.1 2026-04-08 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DB: D1Database;
		ASSETS: Fetcher;
		TMDB_API_READ_KEY: string;
		TMDB_API_KEY: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TMDB_API_READ_KEY" | "TMDB_API_KEY">> {}
}
